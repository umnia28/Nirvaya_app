...
export default function SosPage() {
    ...
    recognition.onresult = (event) => {
      ...
      for (let i = event.resultIndex; i < event.results.length; i++) {
        ...
        for (let j = 1; j < result.length; j++) {
          ...
          if (containsKeyword(alt)) {
            keywordInAlternatives = true;
          }
        }
      }
  ...
  const openReport = async () => {
    ...
    try {
      ...
      showToast(
        "Couldn't get current location. You can enter the incident location manually.",
        "info"
      );
  ...
  const applyManualReportLocation = () => {
    ...
    showToast("Incident location updated.", "success");
  };
    ...
    try {
      ...
      if (!coords) {
        try {
          ...
          throw new Error(
            "Couldn't get report location. Please enter incident latitude and longitude manually."
          );
        }
      }
      ...
      <section className="phone-frame">
        ...
        <section className="sos-content">
          ...
          <div className="card">
            <div
              className={
                voiceEnabled ? "card-icon icon-on" : "card-icon icon-off"
              }
              aria-hidden="true"
            >
          ...
          <button className="route-tab" onClick={() => setAssistantOpen(true)}>
            <div className="card-icon icon-off" aria-hidden="true">
              <MessageCircle size={20} strokeWidth={2.2} />
            </div>

            <div className="card-text-box">
              <p className="card-title">Safety assistant</p>
              <p className="card-subtitle">
                Ask if a route and time look safe before you go
              </p>
            </div>
          ...
          <div className="urgent-sheet report-sheet">
            ...
            <div className="report-location-box">
                ...
                <div>
                  <p className="report-location-title">
                    {reportLocationLoading
                      ...
                      : reportCoords
                      ? "Using incident location"
                      : "No incident location selected"}
                  </p>
              ...
              <div className="report-location-actions">
                ...
                >
                  {showManualLocation ? "Hide" : "Change"}
                </button>
              </div>
            </div>
            ...
            {showManualLocation && (
              <div className="manual-location-box">
                <p className="small-text">
                  Use this if the incident happened somewhere else.
                </p>
                ...
                <div className="manual-location-row">
                  ...
                  <input
                    ...
                    type="number"
                    step="any"
                    placeholder="Incident longitude"
                    value={manualLng}
            ...
            <div className="report-grid">
              {REPORT_CATEGORIES.map((category) => (
                ...
                >
                  <span className="report-chip-emoji">{category.emoji}</span>
                  {category.label}
                </button>
              ))}
            </div>
        ...
        <div className="urgent-overlay" role="dialog" aria-modal="true">
          <div className="assistant-sheet">
            <button
              ...
              aria-label="Close safety assistant"
            >
              <X size={20} />
            </button>
